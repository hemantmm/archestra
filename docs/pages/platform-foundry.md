...
![Screenshot: Foundry agent configuration with GitHub MCP tool and guardrails](/docs/platform-foundry-02.webp)
...
![Screenshot: Agent execution showing it following the malicious instructions](/docs/platform-foundry-03.webp)
